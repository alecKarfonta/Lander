...
public class MainMenu extends AbstractGameScreen {
	...
	private World world; // world just for ground?
	...
	public void render(float delta) {
		...
		ground.render(polygonSpriteBatch);
...
//				switch (keycode) {
//				case Keys.W:
//					ground.setPos(ground.getPos().cpy().add(0,1));
//					break;
//				case Keys.S:
//					ground.setPos(ground.getPos().cpy().add(0,-1));
//					break;
//				case Keys.A:
//					ground.setPos(ground.getPos().cpy().add(-1,0));
//					break;
//				case Keys.D:
//					ground.setPos(ground.getPos().cpy().add(1,0));
//					break;
//				}
//				System.out.println("( " + ground.getPos().x + " , " + ground.getPos().y + " )");
...
//			}
		...
		// create a heading
		Label heading = new Label("Lunar Lander", Assets.instance.skin, "big");
...
//		mainTable.row();
	...
	private void onPlayClicked() {
		...
		game.setScreen(new Play(game, 1), transition);
	}
...
//		stage.setViewport(width, height, true);
	...
	public InputProcessor getInputProcessor() {
		return new InputMultiplexer(inputAdapter, stage);
	}
