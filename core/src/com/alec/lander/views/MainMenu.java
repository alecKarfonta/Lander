...
//import com.alec.lander.GamePreferences;
...
//		float backgroundWidth = 2 * -width;
//		float backgroundHeight = 2 * -height;
...
//
//		// create a heading
//		LabelStyle labelStyle = new LabelStyle(Assets.instance.fonts.defaultBig, Color.WHITE);
//		Label heading = new Label("Comet Command",labelStyle);
//		// heading.scale(3);
//
//		/*
//		 * create some buttons
...
//		buttonStyle.imageUp = new TextureRegionDrawable(Assets.instance.ui.glassPanel);
//		buttonStyle.imageDown =  new TextureRegionDrawable(Assets.instance.ui.glassPanel_corners);
//		
//		ImageTextButton tbPlay = new ImageTextButton("Play", buttonStyle );
...
//		});
//		
//		ImageTextButton tbSettings = new ImageTextButton("Settings", buttonStyle);
...
//			}
//		});
//		ImageTextButton tbExit = new ImageTextButton("Exit", buttonStyle);
//
...
//		windowStyle.background = new TextureRegionDrawable(Assets.instance.ui.metalPanel_yellow);
//		windowStyle.titleFont = Assets.instance.fonts.defaultNormal;
//		
//		
...
//		LabelStyle labelStyle = new LabelStyle(Assets.instance.fonts.defaultNormal, Color.WHITE);
//		CheckBoxStyle checkBoxStyle = new CheckBoxStyle();
//		checkBoxStyle.checkboxOff = new TextureRegionDrawable(Assets.instance.ui.);
//		
//		Table tbl = new Table();
//		// + Title: "Audio"
//		tbl.pad(10, 10, 0, 10);
//		tbl.add(new Label("Audio", labelStyle)).colspan(3);
//		tbl.row();
...
//		
//		
//		chkSound = new CheckBox("", labelStyle);
//		tbl.add(chkSound);
//		tbl.add(new Label("Sound", labelStyle);
...
//		table.add(
//				new Label("Input Mode", Assets.instance.skin, "fontWhite16",
//						Color.ORANGE)).colspan(2);
//
//		table.columnDefaults(0).padRight(10);
//		table.columnDefaults(1).padRight(10);
//		table.row();
//		table.add(new Label("Use Accelerometer", Assets.instance.skin,
//				"default"));
...
//		// + Title: "Debug"
//		tbl.pad(10, 10, 0, 10);
//		tbl.add(new Label("Debug", Assets.instance.skin, "fontWhite16",
//				Color.RED)).colspan(3);
//		tbl.row();
//		tbl.columnDefaults(0).padRight(10);
//		tbl.columnDefaults(1).padRight(10);
...
//
//		final Label lblCredits = new Label(credits.toString(),
